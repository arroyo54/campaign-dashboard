...
description: >
  ...
  accent, the three-step gray text ladder, Lexend Deca (display/numerals/chrome) + Lexend Deca (body),
...
colors:
  ...
  text-muted: "#5A5A5A"
  text-light: "#767676"
  accent-light: "rgba(29, 143, 243, 0.08)"
  accent-medium: "rgba(29, 143, 243, 0.15)"
  border: "rgba(29, 143, 243, 0.2)"
  card-bg: "rgba(29, 143, 243, 0.04)"
  positive: "#047857"
  negative: "#dc2626"
...
typography:
  # — reading ramp (Lexend Deca body + Lexend Deca chrome) —
  body:    { fontFamily: "Lexend Deca", cqw: 0.85, weight: 400, lineHeight: 1.6, color: "text-muted" }
  h4-eyebrow:{ fontFamily: "Lexend Deca", cqw: 0.8, weight: 600, tracking: "0.08em", upper: true, color: "primary" }
  tag:     { fontFamily: "Lexend Deca", px: 12, weight: 500, color: "primary" }
  counter: { fontFamily: "Lexend Deca", px: 13, weight: 500, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (Lexend Deca, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "Lexend Deca", cqw: 1.25, weight: 500, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "Lexend Deca", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "Lexend Deca", cqw: 2.4, weight: 500, lineHeight: 1.35, color: "text" }
  h2:      { fontFamily: "Lexend Deca", cqw: 2.6, weight: 600, lineHeight: 1.1, tracking: "-0.02em", color: "text" }
  metric-value:{ fontFamily: "Lexend Deca", cqw: 3.0, weight: 700, lineHeight: 1.0, color: "primary" }
  h1:      { fontFamily: "Lexend Deca", cqw: 4.2, weight: 700, lineHeight: 1.08, tracking: "-0.02em", color: "text" }
  quote-mark:{ fontFamily: "Lexend Deca", cqw: 8.0, weight: 700, lineHeight: 0.5, color: "primary", opacity: 0.15 }
...
- **Fonts** — already set to **Lexend Deca** (display) / **Lexend Deca** (body); ignore any preset font name lingering in prose.
...
The voice is two faces in fixed roles: **Lexend Deca** (display, every numeral, all chrome —
eyebrows uppercase 0.08em) and **Lexend Deca** (body, muted gray, line 1.6). Headlines are near-black;
...
- **Lexend Deca** (display/numerals/chrome) + **Lexend Deca** (body) — near-black headlines, cobalt numerals.
...
Two ramps. The **reading ramp** (Lexend Deca body 0.85cqw muted; Lexend Deca eyebrow uppercase 0.08em
cobalt) carries copy + chrome; the **display/numerical ramp** (Lexend Deca `h3` 1.25cqw → `h1`
...
- **Headlines near-black, −0.02em**; **eyebrows cobalt, uppercase, 0.08em**; **numerals cobalt 600–700**; **body Lexend Deca 400 muted, line 1.6**. No italic, no uppercase body, no cobalt headline.
...
**Composes** accent-line, meta, h1, body sub. **Focal** a 2-line Lexend Deca `h1` near-black, left,
...
**Focal** a row of tinted cards — cobalt `metric-value` + Lexend Deca label + muted desc + optional
...
blockquote, cite. **Focal** a Lexend Deca `blockquote` near-black under a 15%-opacity cobalt
...
Lexend Deca body column beside a cobalt-8% highlight block (4px cobalt left rule) carrying an inline pull
...
a Lexend Deca `h1` near-black, centered, with the one solid cobalt `cta-button` pill below. **Accent**
...
- Use **tinted cards** (4% fill, 20% border, 10–14px radius, no shadow); body Lexend Deca 400 muted, line 1.6.
...
- **Type** — Lexend Deca headings −0.02em near-black, cobalt eyebrows 0.08em + numerals; Lexend Deca body muted line 1.6; ≥1.4cqw floor.
...
- **Lexend Deca + Lexend Deca via Google Fonts.** CJK pairing (Noto Sans SC 700 display / Noto Serif SC 400 body) carries over; the eyebrow's uppercase+tracking signal weakens in CJK — pair it with the accent-line.
