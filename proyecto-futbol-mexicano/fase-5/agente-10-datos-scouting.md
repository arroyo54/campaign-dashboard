...
**Decisión central [RECOMENDACIÓN, T3-Integrar]:** México debe **adoptar COMET (FIFA Connect compatible)** como registro único del jugador 5–23, no desarrollar plataforma propia. El árbol P2 y la plantilla T-4 rechazan automáticamente el desarrollo propio (T8): existe un sistema probado en 40+ federaciones, **Concacaf ya lo opera**, la implantación nacional probada es de 18–36 meses (la "excepción rápida" del benchmark) y el costo de integrar es inferior al de construir y mantener un sistema ad hoc. La única incógnita material —el costo de licenciamiento para la FMF— está registrada (Q-5B-001) y condiciona el contrato, no la decisión de arquitectura.

**Arquitectura en tres capas sobre activos existentes:** (i) un **identificador único del jugador** (ID-J) emitido en COMET/FIFA Connect y asignado en cuatro puertas ya existentes: registro profesional (Liga MX/Expansión/Premier/TDP), registro amateur (32 asociaciones estatales, digitalizando el Censo Nacional de Afiliados ya previsto en reglamento), **ficha única escolar 6–13** sobre el Mundialito/Copa CONADE (1.18 M de niños en calendario — DEC-010, modelo ONFI) y **portal de certificación de academias FMF**, con certificación condicionada a reportar datos; (ii) un **expediente estándar del jugador** (historial deportivo, pruebas físicas, lesiones, escolaridad, video) interoperable FMF↔SEP↔clubes↔CONADE **por convenio** — la vía que DEC-007 (fila 9 del mapa A3) califica de riesgo FIFA nulo con marco legal 2025 suficiente; (iii) un **Data Box público anual** (modelo japonés, AD) que convierte los levantamientos L1–L8 de DEC-008 en estadística nacional permanente y auditable.

**La protección de datos de menores es restricción de diseño, no anexo:** consentimiento de patria potestad como condición de alta, evaluación de impacto previa a cada módulo, minimización estricta en <12 años (sin video, biometría ni perfilamiento), plazos de conservación y supresión automática, prohibición de uso comercial y de transferencia a agentes sin consentimiento específico, cláusulas de transferencia internacional para FIFA Connect, y gobernanza dual: FMF como responsable con oficial de datos obligatorio, y la Secretaría Anticorrupción y Buen Gobierno como autoridad de tutela, con auditoría externa anual publicada en el Data Box.

**El registro no es un fin estadístico: es infraestructura de incentivos.** Acredita periodos formativos para que academias y clubes de base cobren solidaridad y formación (la Clearing House ya funciona — E1; el cuello es el registro mexicano), alimenta el mecanismo doméstico oneroso que diseña el A6, y corrige sesgos de detección (edad relativa, maduración, región, NSE, género) mediante alertas y cuotas de cobertura de visorías medibles.

**Cumplimiento de reglas:** las 8 recomendaciones REC-DAT son T1–T3 en 7 casos y T6 en 1 (87.5% en T1–T4 — regla del 70% cumplida con holgura); ninguna requiere ley nueva; todas caben en el perímetro DEC-007 de riesgo FIFA nulo. Con el benchmark de 18–36 meses, **el registro operando es la meta 2030 alcanzable por excelencia** (regla de metas: 2030 = hitos de proceso). Se incluye el piloto T-5 PIL-DAT-001 (registro único en 2 estados + cohorte Mundialito).
...
Árbol de decisión P2 (doc. 10 §2) aplicado a cada componente; plantilla T-4 completa para la única alternativa T8 considerada (desarrollo propio), con rechazo automático; contraste contra la matriz de transferibilidad (solo elementos AD/AA); verificación de vía jurídica contra la tabla 5.9 de A3 conforme a DEC-007. Costos no públicos (licencia COMET) se declaran [ESTIMACIÓN] con rango y vía de validación. **Desviación declarada:** ninguna sustantiva; no se pudieron cotejar textos contractuales Analyticom/Concacaf (Q-5B-001).

## 5. Hallazgos (heredados y de diseño)

1. **[HECHO — A1 §5.4]** El registro de afiliados FMF (ACT-SIS-001) es E7: el Reglamento del Sector Amateur prevé un Censo Nacional de Afiliados que no se publica; último censo citable: Big Count 2006 (324,595 registrados). No hay evidencia de sistema integral tipo COMET/FIFA Connect con ID único del amateur al profesional.
...
7. **[INFERENCIA — confianza alta, de diseño]** La transición F2→F4 ("el precipicio invisible") es, en términos de datos, un problema de **emisión del ID en la puerta equivocada**: hoy el ID se emite al llegar al fútbol federado tradicional; si se emite en la puerta escolar y en la academia certificada, el precipicio se vuelve medible y el EPP se puebla desde los 6 años.
8. **[HECHO — literatura B, consistente entre federaciones]** El sesgo de edad relativa (RAE) solo es medible y corregible con fecha de nacimiento registrada y monitoreo por trimestre; los sesgos de región y NSE, solo con domicilio/escuela y proxies socioeconómicos agregados. Sin registro no hay corrección posible: el scouting mexicano actual no puede saber cuánto talento pierde.
...
1. *¿Qué capacidad existe?* COMET operado por Concacaf, probado en 40+ federaciones; FIFA Connect ID como estándar global; registro FMF en papel (E7).
2. *¿Quién la controla?* Analyticom bajo contrato confederativo Concacaf; FIFA (estándar Connect); FMF (registro actual).
3. *¿Por qué no cumple su función?* No está desplegada en México — falla de adopción, no de existencia.
4. *¿Por qué no puede reformarse/adoptarse?* **Sí puede adoptarse.** Sin respuesta sustantiva en contrario → **regla de rechazo R1 del doc. 10 activada contra la creación.**
5. *¿Cuánto costaría adoptar?* 25–60 MDP en 3 años (sección 18; [ESTIMACIÓN, confianza baja], validación Q-5B-001).
6. *¿Cuánto costaría sustituir (desarrollar propio)?* Desarrollo, seguridad, mantenimiento evolutivo, certificación FIFA Connect, soporte: por comparables de plataformas gubernamentales de padrón, ≥3–5× el costo de adopción en 5 años, más 18–30 meses adicionales y riesgo alto de fracaso de TI pública [ESTIMACIÓN, confianza media en orden de magnitud].
7–9. *Funciones/duplicidad:* duplicaría exactamente lo que Concacaf ya opera para sus miembros.
10. *Financiamiento permanente:* la licencia se absorbe en presupuesto operativo FMF + convenio; un sistema propio exigiría partida permanente de desarrollo.
11–13. *Evaluación/supervisión/cierre:* idénticas en ambas opciones (no discriminan).
14. *Riesgo de captura:* el desarrollo ad hoc tiene riesgo alto de captura por proveedor afín; la licencia estándar confederativa lo reduce.
...
- **Contenido:** el estándar de certificación (vertiente deportiva definida por A6) incorpora como requisito: (i) registrar en COMET a todos sus jugadores con ID-J; (ii) reporte semestral de minutos, competencias y bajas; (iii) cumplir el régimen de datos de menores (aviso de privacidad específico, consentimientos, responsable designado); (iv) visorías gratuitas registradas. A cambio, la academia certificada **queda acreditada como formadora en el EPP y puede cobrar** solidaridad/formación — el incentivo que hace autoejecutable la regla. Para no afiliadas, la acreditación opera como incentivo de afiliación (zanahoria, no prohibición — LIM-JUR-001 campo 9).
...
- **Contenido:** publicación anual, en formato abierto y serie continua, de: jugadores registrados por categoría/género/estado/trimestre de nacimiento; entrenadoras/es con licencia vigente y activa (ENDIT+SICCED); academias certificadas y matrícula; minutos juveniles en competencia con consecuencia; visorías y su cobertura territorial; exportación/importación de jugadores; flujos agregados de solidaridad/formación cobrados. Los levantamientos L1–L8 son la línea base del primer Data Box (2027); COMET lo alimenta en adelante. Solo datos agregados y anonimizados: estadística, nunca expedientes.
...
- **Contenido:** (i) **alertas de edad relativa**: distribución por trimestre de nacimiento de cada selección estatal, academia certificada y fuerza básica, con bandera automática cuando Q1>40% (el dato ya existe en la ficha: costo cero); (ii) campo de **maduración biológica** (estatura/peso seriados; edad esquelética opcional solo ≥12 con consentimiento expreso) para habilitar bio-banding en torneos de detección, nunca para exclusión; (iii) **cuotas de cobertura de visorías**: toda visoría de club/academia certificada se registra (lugar, fecha, asistentes, gratuidad); el sistema publica cobertura por región R1–R7 y decil de marginación (CONEVAL), con cuota mínima anual en R6/R7 como condición de la certificación y de los apoyos públicos; (iv) **scouting femenil**: metas explícitas de cobertura de visorías femeniles (línea base vía L5; desagregación por género obligatoria en todo indicador) y pirámide femenil Sub-17/Sub-19 registrada con los mismos estándares de minutos; (v) tablero de selecciones juveniles con alertas de sesgo visibles en cada convocatoria.
...
- **Contenido:** (i) todo periodo con ID-J en academia certificada, club TDP/amateur o programa escolar federado queda asentado como **periodo formativo acreditado** y sincronizado al EPP FIFA; (ii) ventanilla FMF de acompañamiento a clubes de base y academias para reclamaciones ante la Clearing House (hoy no cobran por no aparecer en el EPP — L7 dimensiona el rezago); (iii) el registro provee la base de cálculo de la compensación doméstica onerosa que diseña el A6 (elemento brasileño AD de la matriz R1): este pilar entrega la tubería, A6 el reglamento económico.
...
| **Ubicación** | **Hidalgo** (R4: densidad de activos — Pachuca E1, campus ENDIT/UFD, academias certificables) y **Oaxaca** (R6: desierto profesional, ruralidad, conectividad limitada). Justificación: un estado de alta densidad institucional y uno del desierto R6/R7 — el piloto debe probarse donde es difícil (regla territorial, doc. 01 §5) |
| **Población objetivo** | ~120,000–180,000 NNA 6–17 [ESTIMACIÓN]: participantes Mundialito/Copa CONADE 2027 de ambos estados + matrícula de academias certificadas + clubes TDP/amateur locales; ambas ramas, meta ≥35% de fichas femeniles |
...
|---|---|---|---|---|---|---|
| RG-DAT-001 | FMF trata el registro como activo privado y bloquea Data Box o acceso de contrapartes (patrón E7/E8) | Media-alta | Crítico | Convenio sin cláusula de publicación; retrasos en agregados | Cofinanciamiento público condicionado a Data Box; custodia CONADE de la serie; reversibilidad de datos en contrato COMET | Palanca art. 55/58 LGCFD; publicación de lo público (módulo escolar SEP) aun sin FMF |
| RG-DAT-002 | Incidente de seguridad/uso indebido de datos de menores | Media | Crítico | Hallazgos de auditoría; accesos no trazados | REC-DAT-004 como condición suspensiva; minimización <12; cifrado y logs; auditoría anual | Protocolo de brecha (LFPDPPP), suspensión del módulo, notificación a tutela y familias |
| RG-DAT-003 | Registro capturado por agentes/intermediarios (base de captación temprana) | Media | Alto | Solicitudes de acceso masivo; enriquecimiento con video <12 | Sin acceso de agentes por defecto; clubes solo-lectura ≥12 con log; sanción en certificación | Revocación de accesos, denuncia ante autoridad de datos, caso publicado en Data Box |
| RG-DAT-004 | Padrón paralelo (SEP/CONADE construyen lo suyo; sistema duplicado) | Media | Medio | Licitaciones estatales de "plataformas de talento" | Convenio marco único (REC-DAT-008) con FIFA Connect como interfaz obligatoria | Arbitraje A0/A15; condicionar fondos a interoperar |
| RG-DAT-005 | Baja adopción amateur/rural (asociaciones E7 sin capacidad; conectividad R6/R7) | Alta | Medio | Piloto Oaxaca con <40% de captura | Captura offline-first; puerta escolar (capilaridad SEP); incentivo de certificación | Extender fase 2; brigadas de registro en torneos y visorías |
| RG-DAT-006 | Cuotas de visorías cumplidas en papel (gaming) | Media | Medio | Visorías registradas sin fichas nuevas | Visoría válida solo con asistentes con ID-J; verificación muestral independiente | Ajustar fórmula (visorías con producto, no eventos) |
| RG-DAT-007 | Discontinuidad sexenal del componente público — RG-A1-004 heredado | Media-alta | Alto | PEF sin partida; cambio de reglas de operación | Serie en datos.gob.mx + dictamen INEGI; multi-firma con 32 estados | El núcleo federativo (COMET) sobrevive solo; módulo escolar se reconstruye en el siguiente ciclo |

## 22. Bloqueadores políticos/jurídicos/económicos

1. **Voluntad de la asamblea FMF** para la obligatoriedad del registro en competencias afiliadas (vía RL): su venta política es que el registro **les cobra a los clubes menos de lo que les paga** (acredita formación → cobros Clearing House; datos de cantera → valor de venta). 2. **Opacidad contractual** (Q-5B-001): riesgo de sobrecosto sin precio de referencia. 3. **Fragmentación de 32 autoridades educativas estatales**: se mitiga con adhesión gradual (piloto → 8 → 32). 4. **Autoridad de datos nueva** (Secretaría Anticorrupción, sin práctica deportiva): riesgo y oportunidad. 5. **No hay bloqueador FIFA:** todo el paquete está en la fila 9 del mapa A3 (riesgo nulo) y FIFA Connect es política FIFA activa — este pilar rema *a favor* del regulador internacional.
...
6. **Riesgo residual honesto:** la escala (~10× los federados de Croacia o Uruguay) y el federalismo educativo de 32 sistemas estatales no tienen precedente exacto en el benchmark; por eso el piloto incluye el caso difícil (Oaxaca) y criterios de cancelación ex ante.
...
**A.1 Consentimiento.** El alta de todo menor requiere consentimiento informado de quien ejerce patria potestad/tutela, específico por finalidad (registro deportivo ≠ scouting ≠ video ≠ investigación), revocable con supresión efectiva, en lenguaje llano (aviso de privacidad específico para visorías masivas y ficha escolar — hoy inexistentes). El adolescente ≥15 co-firma. La negativa **nunca** excluye de jugar: solo del expediente ampliado.
...
**A.3 Contenido del expediente (≥12) y finalidades tasadas.** Historial deportivo (minutos, posiciones, competencias — base del EPP), pruebas físicas seriadas, lesiones (visible solo para personal médico autorizado), trayectoria escolar (solo estatus de permanencia/grado, vía SEP — dato de protección, no de selección), video (consentimiento específico, cifrado). Finalidades permitidas: gestión de competencia, desarrollo deportivo, salud, acreditación formativa, estadística agregada. **Prohibidas sin consentimiento específico adicional:** uso comercial, cesión a agentes/intermediarios, publicidad, venta de bases de datos — la violación revoca la certificación de la academia o activa sanción reglamentaria al club y denuncia ante la autoridad de datos.
...
*Fin del entregable del Agente 10. Extensión aproximada: 7,000 palabras. Las recomendaciones REC-DAT-001 a 008, los indicadores IND-DAT-001 a 008, los riesgos RG-DAT-001 a 007, el piloto PIL-DAT-001 y las preguntas Q-DAT-001 a 005 quedan inscritos para integración del Agente 0 en Fase 6.*
